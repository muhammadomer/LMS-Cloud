...
(function ($) {
    ...
    $.FileDialog = function FileDialog(userOptions) {
        var options = $.extend($.FileDialog.defaults, userOptions),
            modal = $([
                "<div id='loadUserImageModal' class='modal fade'>",
                ...
                "                                data-dismiss='modal'>",
                                     options.cancel_button,
                "                </button>",
                "                <button id='uploadButton' type='button' class='btn btn-primary purple bfd-ok'>",
                                     options.ok_button,
                "                </button>",
                "            </div>",
                "        </div>",
        ...
        var loadFile = function (f) {
            ...
            console.log("Files Data" + progress);
